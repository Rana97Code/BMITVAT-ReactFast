...
const CpcAdd = () => {
    ...
    const [cpcCode, setCode] = useState("");
    const [costingStatus, setcpcStatus] = useState("");
                          ...
                          <form className="space-y-5" onSubmit={handleSubmit}>
                              <div className="flex sm:flex-row flex-col">
                                  ...
                                  <input id="cpc_name" type="text" placeholder="Enter CPC Name" className="form-input flex-1" 
                                   name = "cpc_name" onChange={(e) => setName(e.target.value)} required />
                              </div>
                              ...
                              <div className="flex sm:flex-row flex-col">
                                  ...
                                  <input id="cpc_code" type="text" placeholder="Enter CPC Code" className="form-input flex-1" 
                                   name = "cpc_code" onChange={(e) => setCode(e.target.value)} required />
                              </div>
                              <div className="flex sm:flex-row flex-col">
