...
import TableGForeignPurchase from './tableLocalPurchase';
                    ...
                    selectedLiElements.forEach(async(liElement) => {
                        ...
                        liElement.addEventListener('click', () => {
                          ...
                          if(clickedValue>0){
                            ...
                            axios.get(`${baseUrl}/item/get_item/${clickedValue}`,{headers})
                                .then((response) => {
                                    const data = response.data;
                                    setItemDetails(data);
                                    addRow(data);
                            ...
                            <div className="mb-5">
                                <form className="space-y-5" onSubmit={handleSubmit}>
                                    ...
                                    <div className="grid grid-cols-5 gap--x-2 gap-y-3">
                                        ...
                                        <textarea id="user_name" placeholder="Notes..." className="form-input py-2.5 text-sm col-span-4" onChange={(e) => setNote(e.target.value)} />
                                    </div>
