...
const index = () => {
    ...
    useEffect(() => {
        ...
        if (token) {
            ...
            axios.get('http://localhost:8080/bmitvat/api/waste_management', { headers })
                .then((response) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (data) {
            navigate(`/pages/report/waste_management/` + data);
        }
                    ...
                    <form onSubmit={handleSubmit} >
                        <div className="flex md:items-center justify-between md:flex-row flex-col mb-4.5 gap-5">
                            <div className="flex items-center justify-between mb-3">
                                <div>
                                    <label htmlFor="selectMonth">From Date</label>
                                ...
                                <div className="ml-16 w-36">
                                    <label htmlFor="selectMonth">To Date</label>
                                    <input id="selectMonth" type="date" value={lcDate} onChange={(e) => setLcDate(e.target.value)} className="form-input" required />
                                </div>
                                <div className="ml-16 w-36">
