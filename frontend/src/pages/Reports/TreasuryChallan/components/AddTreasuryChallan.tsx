                ...
                <div id="forms_grid">
                    ...
                    <div className="mb-5">
                        <form className="space-y-5" onSubmit={handleSubmit} >
                            ...
                            <div>
                                <div className="grid grid-cols-5 gap--x-2 gap-y-3" >
                                    <label htmlFor="chalanDate" className='col-span-1 text-base'>Chalan Date</label>
                                    <input id="chalanDate" type="date" className="form-input py-2.5 text-base col-span-4"
                                        name="chalanDate" value={chalanDate} onChange={(e) => setChalanDate(e.target.value)} />
                                </div>
                            </div>
                            <div>
                                <div className="grid grid-cols-5 gap--x-2 gap-y-3" >
