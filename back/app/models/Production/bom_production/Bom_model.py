...
from sqlalchemy import Column,String,Integer,Boolean,SmallInteger,DateTime,Date,Text,Double,Float,BigInteger,Float
...
class Bom(Base):
    ...
    total_costing = Column(Float, nullable=True, name="total_costing")
    item_price = Column(Float, nullable=True, name="item_price")
    sales_price = Column(Float, nullable=True, name="sales_price")
...
class BomCosting(Base):
    ...
    cost = Column(Float, nullable=True, name="cost")
    user_id = Column(Integer, nullable=True, name="user_id")
...
class BomRawMaterials(Base):
    ...
    unit_name = Column(String, nullable=True, name="unit_name")
    material_qty = Column(Float, nullable=True, name="material_qty")
    material_rate = Column(Float, nullable=True, name="material_rate")
    material_price = Column(Float, nullable=True, name="material_price")
    wastage_percent = Column(Integer, nullable=True, name="wastage_percent")
    wastage_qty = Column(Float, nullable=True, name="wastage_qty")
    wastage_price = Column(Float, nullable=True, name="wastage_price")
    total_qty = Column(Float, nullable=True, name="total_qty")
